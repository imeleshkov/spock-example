...
class PagesPathsMap {
    ...
    PagesPathsMap() {
        this.pathsMap = [
                ...
                (IdentityCheckPage.class)               : '/checkout/multi/identity-check',
                (ThreeDSHostingPage.class)              : '/checkout/multi/3dsHostingPage',
                (AcquisitionSecurePageFrame.class)      : '/checkout/multi/threeDSHostedPage',
                (AcquisitionThreeDSBreakoutPage.class)  : '/checkout/multi/threeDSBreakout',
                (AcquisitionOrderConfirmationPage.class): '/checkout/orderConfirmation/$orderId',
                //AddLine flow
